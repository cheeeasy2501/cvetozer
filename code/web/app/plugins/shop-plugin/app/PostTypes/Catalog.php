...
class Catalog
{
    ...
    /**
     * Catalog post type register
     */
    public static function register(): void {
        $instance = new self;

        add_action('init', [$instance, 'registerPostType']);
        add_filter('post_updated_messages', [$instance, 'catalogUpdateMessages']);
    }

    /**
     * Catalog post type settings
     *
     * @return array
     */
    ...
    /**
     * Catalog post type messages
     *
     * @param $messages
     * @return mixed
     */
    function catalogUpdateMessages($messages) {
        global $post;
